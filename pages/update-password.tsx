...
const UpdatePassword: FC<{ session: Session }> = ({ session }) => {
  return <div>
      <h1  className="h3 mb-2 text-gray-800">UpdatePassword</h1>
                            ...
                            <div className="col-lg-7">
                                <div className="p-5">
                                    <div className="text-center">
                                        <h1 className="h4 text-gray-900 mb-4">Update password</h1>
                                    </div>
                                    <form className="user"> 
